...
$(document).ready(function () {
	...
	$('#currentAge').text(calculateAge(new Date('04/13/1996')));
});
...
function lazyLoad(poContainer) {
	var lstrCount = 4;
	var lstrIndex = Math.floor(Math.random() * lstrCount) + 1;
	var lstrSource = poContainer.attr('data-src') + lstrIndex + '.jpg';
